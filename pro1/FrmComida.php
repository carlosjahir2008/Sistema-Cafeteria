...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['agregar_comida'])) {
    ...
    $sql = "INSERT INTO menu_comida (nombre, precio, imagen, descripcion) VALUES (?, ?, ?, ?)";
...
if (isset($_GET['eliminar'])) {
    ...
    $sql_eliminar = "DELETE FROM menu WHERE id = ?";
...
$sql_menu = "SELECT id, nombre, precio, imagen, descripcion FROM menu_comida";
