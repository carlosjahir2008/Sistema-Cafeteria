...
<body>
    ...
    <div class="menu-grid">
        <?php
        $menu = [
            ["nombre" => "Tacos", "precio" => 80, "imagen" => "./img_pruebas/taco.jpg", "descripcion" => "Tacos con carne"],
            ["nombre" => "Hamburguesa", "precio" => 100, "imagen" => "./img_pruebas/hamburguesa.jpg", "descripcion" => "Con papas"],
            ["nombre" => "Pizza", "precio" => 120, "imagen" => "./img_pruebas/pizza.jpg", "descripcion" => "Porción individual"],
            ["nombre" => "Tacos", "precio" => 80, "imagen" => "./img_pruebas/taco.jpg", "descripcion" => "Tacos con carne"],
            ["nombre" => "Hamburguesa", "precio" => 100, "imagen" => "./img_pruebas/hamburguesa.jpg", "descripcion" => "Con papas"],
            ["nombre" => "Pizza", "precio" => 120, "imagen" => "./img_pruebas/pizza.jpg", "descripcion" => "Porción individual"],
            ["nombre" => "Tacos", "precio" => 80, "imagen" => "./img_pruebas/taco.jpg", "descripcion" => "Tacos con carne"],
